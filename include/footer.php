   ...
   <div class="it-footer-wrap fix">
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="it-footer-widget it-footer-col-1-1">
                     <div class="it-footer-widget-logo mb-10">
                        <!-- <h3>Gordon college</h3> -->
                         <img src="assets/img/campus/footer-logo.png" alt="" style="width: 150px;">
                     </div>
                     ...
                     <div class="it-footer-widget-btn">
                        <a href="contact-us.php" class="it-btn-yellow theme-bg">
                           <span>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="it-footer-widget it-footer-col-1-2">
                     ...
                     <div class="it-footer-widget-menu">
                        <ul>
                           <li><a href="igcse-ShortCourse.php">IGCSE and short courses</a></li>
                           <li><a href="university-entry.php">Level 3 Course</a></li>
                           <li><a href="level-4-5-University-first-and-second-year -ourses.php">Level 4 Course</a></li>
                           <li><a href="undergraduate.php">Level 5 Course</a></li>
                           <li><a href="diploma-master-mba.php">Level 6 Course</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="it-footer-widget it-footer-col-1-4 d-flex justify-content-lg-end">
                     <div>
                        ...
                        <div class="it-footer-widget-contact mb-25">
                           <ul>
                              <li><span>Phone:</span><a href="tel:+91123456789">+44 2045770424</a></li>
                              <li><span>Email:</span><a href="mailto:admission@gordon-college.com">admission@gordon-college.com</a></li>
                              <li><span>Location:</span><a target="_blank" href="#">GORDON COLLEGE LTD  , 167-169 Great Portland Street, London, England, W1W 5PF</a></li>
                           </ul>
                        </div>
      ...
      <div class="it-copyright-area it-copyright-ptb it-copyright-bg z-index-1 yellow-bg">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-xl-6 col-lg-5">
                  <div class="it-copyright-left style-2 text-center text-lg-start">
                     <p class="mb-0">Copyright © 2025 <a href="#">Gordon College</a> All Rights Reserved</p>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-7">
                  <div class="it-copyright-menu text-center text-lg-end">
                     <a class="border-line" href="#">Terms of service</a>   
                     <span>-</span>              
                     <a class="border-line" href="#">Privacy policy</a>                 
                     <span>-</span>   
                     <!-- <a class="border-line" href="#">Subscription</a>    
                     <span>-</span>                
                     <a class="border-line" href="#">Login & Register</a>                       -->
                  </div>
               </div>
            </div>
         </div>
