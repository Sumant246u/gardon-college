...
<html class="no-js" lang="zxx">
  ...
  <body>
      ...
      <div id="it-loading-center">
        <div id="it-loading-absolute">
          <div class="it-loading-content">
            <img
              class="it-loading-logo"
              src="assets/img/campus/footer-logo.png"
              alt=""
            />
            <div class="it-loading-stroke">
              <!-- <img class="it-loading-icon" src="assets/img/logo/pencil.png" alt=""> -->
            </div>
            <span>"Loading Knowledge... Please Wait Wisely!"</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="search-popup">
      <button class="close-search">
        <span class="flaticon-multiply"><i class="fal fa-times"></i></span>
      </button>
        ...
        <div class="itoffcanvas__info">
          ...
          <div class="it-info-wrapper mb-20 d-flex align-items-center">
            ...
            <div class="itoffcanvas__info-address">
              <span>Email</span>
              <a href="maito:admission@gordon-college.com"
                >admission@gordon-college.com</a
              >
            </div>
          </div>
          <div class="it-info-wrapper mb-20 d-flex align-items-center">
          ...
          <div class="it-info-wrapper mb-20 d-flex align-items-center">
            ...
            <div class="itoffcanvas__info-address">
              <span>Location</span>
              <a href="#" target="_blank">GORDON COLLEGE LTD  , 167-169 Great Portland Street, London, England, W1W 5PF </a>
            </div>
          </div>
        </div>
      </div>
  ...
  <header class="it-header-height">
      ...
      <div class="it-header-top-area  it-header-top-ptb" style="background-color: #03594E;">
         <div class="container">
                     ...
                     <ul>
                        <li class="d-none d-lg-inline-block d-lg-inline-block">
                           <div class="it-header-top-contact d-flex align-items-center">      
                              ...
                              <a class="border-line" href="tel:+44 2045770424">+44 2045770424</a>
                           </div>
                        </li>
                        <li>
                           <div class="it-header-top-contact d-flex align-items-center">
                              ...
                              <a class="border-line" href="mailto:admission@gordon-college.com">admission@gordon-college.com</a>
                           </div>
                        </li>
                     </ul>
                  </div>
               </div>      
               <div class="col-xl-7 col-lg-7 col-md-8 col-sm-7 d-none d-sm-block">
                  <div class="it-header-top-right-action d-flex align-items-center justify-content-end">
                     ...
                     <div class="it-header-top-social-box align-items-center d-none d-md-flex">
                        <span>Follow On:</span>
                        <a href="https://www.facebook.com/gordoncollegeuk" target="_blank">
                        ...
                        <a href="https://www.instagram.com/gordoncollege.uk" target="_blank">
                        ...
                        <a href="https://www.linkedin.com/company/111247018" target="_blank">
               ...
               <div class="row align-items-center">
                  <div class="col-xxl-2 col-xl-2 col-lg-4 col-md-5 col-6">
                     <div class="it-header-logo">
                       <a href="index.php"><img src="assets/img/campus/footer-logo.png" alt="" style="width: 90px;"></a>
                     </div>
                  </div>
                        ...
                        <nav class="it-menu-content">
                           <ul>
                                    ...
                                    <div class="row gx-20">
                                       <div class="col">
                                          <div class="it-megamenu-item">
                                             <h4 class="it-megamenu-title"><a href="igcse-ShortCourse.php">IGCSE and short courses</a></h4>
                                             <ul>
                                                <li><a href="Igcsc-biology.php">IGCSE Biology</a></li>
                                                <li><a href="igcsc-Business-studies.php">IGCSE Business Studies</a></li>
                                                <li><a href="chemistry.php">IGCSE Chemistry</a></li>
                                                <li><a href="computerScience.php">IGCSE Computer Science</a></li>
                                                <li><a href="english-first.php">IGCSE English First Language</a></li>
                                                <li><a href="enviromental-mangement.php">IGCSE Environmental Management</a></li>
                                                <li><a href="geography.php">IGCSE IGCSE Geography</a></li>
                                                <li><a href="history.php">IGCSE History</a></li>
                                                <li><a href="mathematics.php">IGCSE Mathematics</a></li>
                                                <li><a href="physics.php">IGCSE Physics</a></li>
                                                <li><a href="travel-turism.php">IGCSE Travel and Tourism</a></li>
                                                <li><a href="english.php">English Language Course (IELTS Training)</a></li>
                                             </ul>
                                          </div>
                                       </div>
                                       <div class="col">
                                          <div class="it-megamenu-item">
                                             <h4 class="it-megamenu-title"> <a href="university-entry.php">Level 3 (A level) - University entry courses</a></h4>
                                             <ul>
                                                <li><a href="accountancy.php">Accountancy (60 Credits)</a></li>
                                                <li><a href="level-Three-business.php">Business Management (120 Credits)</a></li>
                                                <li><a href="level-busines-studies.php">Business Studies (60 Credits)</a></li>
                                                <li><a href="emplybility.php">Employability and Workplace Skills (60 Credits)</a></li>
                                                <li><a href="engineering.php">Engineering (60 Credits)</a></li>
                                                <li><a href="health-socialcare.php">Health & Social Care (60 Credits)</a></li>
                                                <li><a href="people-organisation.php">People and Organisations (60 Credits)</a></li>
                                                <li><a href="informationTechnology.php">Information Technology (60 credits)</a></li>
                                             </ul>
                                          </div>
                                       </div>
                                       <div class="col">
                                          <div class="it-megamenu-item">
                                             <h4 class="it-megamenu-title"><a href="level-4-5-University-first-and-second-year -ourses.php">Level 4 & 5 - University first and second year courses</a></h4>
                                             <ul>
                                                <li><a href="accounting-business.php">Accounting and Business</a></li>
                                                <li><a href="businessManagement.php">Business Management</a></li>
                                                <li><a href="enterprenurship-management.php">Entrepreneurship and Management</a></li>
                                                <li><a href="health-socialCareManagement.php">Health & Social Care Management</a></li>
                                                <li><a href="human-ResourceManagement.php">Human Resource Management</a></li>
                                                <li><a href="logiSupplyChain.php">Logistics and Supply Chain Management</a></li>
                                                <li><a href="it-Computing.php">IT and Computing</a></li>
                                                <li><a href="it-Ecommerce.php">IT and E-commerce</a></li>
                                                <li><a href="it-Networking.php">IT and Networking</a></li>
                                                <li><a href="it-WebDesign.php">IT and Web Design</a></li>
                                                <li><a href="leaderShip-Teamwork.php">Leadership and Teamwork</a></li>
                                                <li><a href="sales-Marketing.php">Sales and Marketing</a></li>
                                                <li><a href="tourism-hospitality.php">Tourism and Hospitality Management</a></li>
                                             </ul>
                                          </div>
                                       </div>
                                       <div class="col">
                                          <div class="it-megamenu-item">
                                             <h4 class="it-megamenu-title"><a href="undergraduate.php">Level 6 Undergraduate / Final year</a></h4>
                                             <ul>
                                                <li><a href="levelSix-business-management.php">Business Management</a></li>
                                                <li><a href="professional-sales.php">Professional Sales Management</a></li>
                                             </ul>
                                          </div>
                                       </div>
                                       <div class="col">
                                          <div class="it-megamenu-item">
                                             <h4 class="it-megamenu-title"><a href="diploma-master-mba.php">Level 7 Diploma, Masters / MBA Advance Entry</a></h4>
                                             <ul>
                                                <li><a href="levelSeven-HumanResource.php">Human Resource Management</a></li>
                                                <li><a href="strategic-Management.php">Strategic Management and Leadership</a></li>
                                                <li><a href="strategic-saless.php">Strategic Sales Management</a></li>
                                                <li><a href="project-Management.php">Project Management</a></li>
                                                <li><a href="organisational-psychology.php">Organisational Psychology and Business</a></li>
                                             </ul>
                                          </div>
                                       </div>
                              ...
                              <li class="has-dropdown">
                                 <a href="#">Most Popular Courses</a>
                                 <ul class="it-submenu submenu">
                                    <li><a href="business-management.php">Business Management (120 Credits)</a></li>
                                    <li><a href="businessManagement.php">Business Management</a></li>
                                    <li><a href="health-socialCareManagement.php">Health & Social Care Managememnt</a></li>
                                    <li><a href="it-Computing.php">IT & Computing</a></li>
                                    <li><a href="strategic-Management.php">Strategic Management & Leadership</a></li>
                                 </ul>
                              </li>
                              <li class="has-dropdown">
                                 <a href="#">Individuals</a>
                                 <ul class="it-submenu submenu">
                                    <li><a href="how-will-you-learn.php">How you will learn</a></li>
                                    <li><a href="top-up-degree.php">Top UP degrees</a></li>
                                    <li><a href="our-hub.php">Our Hubs</a></li>
                              ...
                              <li class="has-dropdown">
                                 <a href="#">Business</a>
                                 <ul class="it-submenu submenu">
                                    <li><a href="business-overview.php">Overview</a></li>
                                    <li><a href="University-Pathway-Programmes.php">University pathway programmes</a></li>
                                    <li><a href="Short-course-CPD.php">Short course CPD Modules</a></li>
                                 </ul>
                              </li>
                              ...
                              <li class="has-dropdown">
                                 ...
                                 <ul class="it-submenu submenu">
                                    ...
                                    <li><a href="credential.php">Our credentials</a></li>
                                 </ul>
                              </li>
                           </ul>
                        </nav>
                  ...
                  <div class="col-xxl-2 col-xl-2 col-lg-8 col-md-7 col-6">
                     <div class="it-header-right-action d-flex justify-content-end align-items-center">
                        <a href="contact-us.php" class="it-btn-yellow d-none d-md-flex">
                           <span>
                              <span class="text-1">Contact Now</span>
                              <span class="text-2">Contact Now</span>
                           </span>
                           <!-- <i>
                        ...
                        <a href="enroll-now.php" class="it-btn-yellow d-none d-md-flex">
                           <span>
